...
}else if(MY_URL.indexOf("xjiys")!=-1){thumb=thumb.replace("img.maccms.com","xjiys.com");}else if(MY_URL.indexOf("shidian")!=-1){thumb=thumb.replace("img.maccms.com","shidian.vip");}else if(MY_URL.indexOf("17kanju")!=-1){thumb=thumb.replace("img.maccms.com","img.17kanju.com");}else if(MY_URL.indexOf("potatost")!=-1){thumb=thumb.replace("http://img.maccms.com//pic=","");}
...
url:url.replace(/\n*/g,'')+`@lazyRule=.js:var src=input.replace(/amp;/g,"");if(src.indexOf("html")!=-1){var jiek="https://1717.ntryjd.net/0526/?url=";var fileUrl="https://gitee.com/lzk23559/public_folder/raw/master/parse.js";var js=fetch(fileUrl,{});eval(js);var url=yqjx.toUrl(jiek+src.split('"')[0]);url!=""?url:getUrl(jiek+src.split('"')[0]);}else if(src.indexOf("135-cdn")!=-1){refreshX5WebView(src);"toast://请等待加载选集！";}else if(src.indexOf("share")!=-1){var link=src.split("/share")[0];var fc=fetch(src,{}).replace("var purl","var main");if(fc.indexOf("main")!=-1){var mat=fc.match(/var main.*?;/)[0];eval(mat);main.indexOf("http")!=-1?main:link+main;}else{var main=fc.match(/url:.*?[\'\"](.*?)[\'\"]/)[1];main.indexOf("http")!=-1?main:link+main};}else if(src.indexOf("meiju11")!=-1){fetch(input,{headers:{"Referer":"https://www.meiju11.com"}}).match(/url:.*?[\'\"](.*?)[\'\"]/)[1];}else if(src.indexOf("leduotv")!=-1){var pla=fetch(src,{}).split("var url=\'")[1].split("\'")[0];if(pla.indexOf("m3u8")!=-1){pla.split("=")[1]};}else if(src.indexOf("aHR0c")!=-1){decodeURIComponent(base64Decode(src.split("&")[0]));}else if(src.indexOf("haodanxia")!=-1||src.indexOf("cqzyw")!=-1){var ul=JSON.parse(fetch(src, {headers:{"User-Agent":"Dalvik/2.1.0"}, redirect:false, withStatusCode:true}));if(ul.statusCode=="302"){ul.headers.location[0];}else{src};}else if(src.indexOf("shenma4480")!=-1){var sm="https://www.shenma4480.com/"+fetch(src,{headers:{"Referer":"https://www.shenma4480.com"}}).match(/var u=\"(.*?)\"/)[1];fetch(sm,{headers:{"Referer":"https://www.shenma4480.com"}}).match(/url:.*?[\'\"](.*?)[\'\"]/)[1].replace(/[+]/g,"%20");}else if(src.indexOf("mlkioiy")!=-1){if(src.indexOf("ShowVideo")!=-1){var mlki=parseDomForHtml(fetch(src,{}),"body&&#dplayer&&result");var fileUrl ="https://gitee.com/lzk23559/rulehouse/raw/master/pako-min.js";eval(fetch(fileUrl,{}));realUrl;}else{src+"#.mp4"};}else if(src.indexOf("ddyunp")!=-1||src.indexOf("90mm.me")!=-1){if(!fetch("hiker://files/rules/js/kem.js",{})){refreshX5WebView(src);"toast://请等待加载选集！";}else{var fileUrl="hiker://files/rules/js/kem.js";var ddjs=fetch(fileUrl,{});eval(ddjs);tools.DdyunPlayer.toUrl(src).replace("ddyunp.com","90mm.me")};}else if(src.indexOf("xsp1")!=-1){var pli=parseDomForHtml(fetch(src,{headers:{"Referer":"https://zz22x.com"}}),"body&&iframe&&src").split("url=")[1];var jiek="https://1717.ntryjd.net/0526/?url=";var fileUrl="https://gitee.com/lzk23559/public_folder/raw/master/parse.js";var js=fetch(fileUrl,{});eval(js);var url=yqjx.toUrl(jiek+pli);url!=""?url:getUrl(jiek+pli);}else if(src.indexOf("baipiaozy")!=-1||src.indexOf("bowang")!=-1){refreshX5WebView(src);"toast://请等待加载选集！";}else if(src.indexOf("murl")!=-1){refreshX5WebView(src);"toast://请等待加载选集！";}else if(src.indexOf("47api")!=-1){refreshX5WebView(src);"toast://请等待加载选集！";}else{src}`,
col_type: 'text_2'});
   }
  }
 }
